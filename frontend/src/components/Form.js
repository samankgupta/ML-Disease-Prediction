            ...
            <div>
              <div className="px-7 pt-6 pb-2 grid grid-cols-2">
                ...
                <img
                  ...
                  alt="Close"
                  className="w-5 ml-auto cursor-pointer"
                  onClick={() => modalClose("doctormodal")}
                ></img>
              </div>
              <div className="overflow-y-auto mt-4 mx-12 mb-8">
                <h1 className="text-lg bg-clip-text text-transparent font-bold bg-gradient-to-r from-green-800 to-green-500 text-center mt-4">
                  ...
                  <span className="text-black font-normal">
                    {" "}
                    of Cardiology Department on 12 November 2021 (Friday) at
                    11:30 AM.
                  </span>
                </h1>
              </div>
                          ...
                          {symptoms.map((symp) => (
                            <div className="col-span-8 md:col-span-12">
                              ...
                              <select
                                ...
                                onChange={(e) =>
                                  handleSymptom(e.target.value, symp)
                                }
