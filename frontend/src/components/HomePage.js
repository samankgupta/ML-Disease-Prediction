                    ...
                    <div className="absolute top-16 left-24 ">
                        <div className="pt-20">
                            <div className="text-center">
                                ...
                                <h1 className="text-5xl font-extrabold pt-10"><span className="bg-clip-text text-transparent bg-gradient-to-r from-green-800 to-green-500 filter drop-shadow hover:drop-shadow-lg">DISEASE PREDICTOR</span></h1><br />
